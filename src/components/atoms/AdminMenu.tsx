    ...
    <>
        <div className="w-[20%] hidden md:block">
            <div className="flex flex-col w-full">
                ...
                <div className={location.pathname === '/admin/deleted' ? "bg-blue-500 p-[20px] text-white cursor-pointer" : "hover:bg-gray-300 p-[20px] text-slate-800 cursor-pointer"}><strong><Link to={'/admin/deleted'}>Deleted Products</Link></strong></div>
